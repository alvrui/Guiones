...
export const ProjectPage = () => {
  ...
  const handleDeleteProject = async (id: string) => {
    if (window.confirm("¿Estás seguro de que quieres borrar este proyecto? Esta acción no se puede deshacer.")) {
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600">
              {proyectos.length} proyecto{proyectos.length !== 1 ? "s" : ""} creado{proyectos.length !== 1 ? "s" : ""}
            </p>
          </div>
          <button
        ...
        {proyectoActual && (
          <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {proyectoActual.contexto_cultural && (
                <div className="md:col-span-2">
                  <p className="text-sm text-gray-600 mb-1">Contexto Cultural</p>
                  <p>{proyectoActual.contexto_cultural}</p>
                </div>
              )}
              {proyectoActual.entorno_sensorial && (
                <div className="md:col-span-2">
                  <p className="text-sm text-gray-600 mb-1">Entorno Sensorial</p>
                  <p>{proyectoActual.entorno_sensorial}</p>
                </div>
              )}
              {proyectoActual.temas_principales && proyectoActual.temas_principales.length > 0 && (
                <div className="md:col-span-2">
